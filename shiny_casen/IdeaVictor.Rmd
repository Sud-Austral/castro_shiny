...
<!--     write.csv(df,"tabla_028_2006.csv", row.names = FALSE) -->
...
<!--     write.csv(df,"tabla_028_2009.csv", row.names = FALSE) -->
...
ab  <- dataset2011
    ...
    write.csv(df,"tabla_022_etnia_2011.csv", row.names = FALSE)
```
...
```{r}
    ...
    write.csv(df,"tabla_022_etnia_2013.csv", row.names = FALSE)
```
...
```{r}
    ...
    write.csv(df,"tabla_022_etnia_2015.csv", row.names = FALSE)
```
...
```{r}
    ...
    write.csv(df,"tabla_022_etnia_2017.csv", row.names = FALSE)
```
