...
```{r}
    ...
    write.csv(df,"tabla_004_2006.csv", row.names = FALSE)
...
```{r}
    ...
    write.csv(df,"tabla_004_2009.csv", row.names = FALSE)
...
ab  <- dataset2011
    ...
    write.csv(df,"tabla_004_2011.csv", row.names = FALSE)
```
...
```{r}
    ...
    write.csv(df,"tabla_004_2013.csv", row.names = FALSE)
```
## 2015
...
```{r}
    ...
    write.csv(df,"tabla_004_2015.csv", row.names = FALSE)
```
...
```{r}
    ...
    write.csv(df,"tabla_004_2017.csv", row.names = FALSE)
```
