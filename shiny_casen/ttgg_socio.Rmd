---
title: "Tablas de contingencia de interés social con los datos de la Casen"
author: "DI"
date: "11-11-2020"
output: html_document
---

#### Se plantean una serie de preguntas de interes social para determinar la mejor forma de presentar la informacion mediante tablas de contingencia. Se toman como ejemplos
...
#### consiste en marginar y separar a ciertas personas porque se las considera inferiores a las demás.
...
#### El módulo R de la Casen 20017, Identidades, redes y participación contiene un set de discriminacion por 17 categorias y un otro
...
## pobreza pr comuna, sexo y estado civil

```{r echo = FALSE, error=FALSE, warning=FALSE, message=FALSE}
# vec %na<-% 0
# bloque bueno
tabla_cro_cpct <- cro_cpct(dataset$"Situación de pobreza multidimensional (4 dimensiones)", list(total(), dataset$Comuna   %nest% dataset$Sexo %nest% dataset$"Estado civil"))
tabla_cro_cpct
...
#dataset$"pobreza_multi_4d"
```
Esto se modifico ahora ultimo

```{r echo = FALSE, error=FALSE, warning=FALSE, message=FALSE}



tabla_cro_cpct <- cro_cpct(dataset$"Situación de pobreza multidimensional (4 dimensiones)", list(total(), dataset$"r3. Pueblos indígenas, ¿pertenece usted o es descendiente de alguno de ellos?"))
tabla_cro_cpct
